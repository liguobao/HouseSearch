...
namespace HouseMap.Crawler
{
    ...
    public class Hizhu : NewBaseCrawler
    {
        ...
        {
            var client = new RestClient($"https://s.loulifang.com.cn/houselist.html?pageno={pageno}&city_code={city_code}&limit=50&sort=-1&money_max=999999&money_min=0&logicSort=0&region_id=&plate_id=&line_id=0&stand_id=0&type_no=0&search_id=&key=&key_self=0&latitude=&longitude=&distance=0&other_ids=&update_time=0");
